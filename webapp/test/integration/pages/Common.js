sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/sapmentors/sitreg/participantlist/app", ".html");
		...
		return Opa5.extend("com.sap.sapmentors.sitreg.participantlist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/sapmentors/sitreg/participantlist/localService/mockserver"], function (mockserver) {
